...
use tokio::{io::{AsyncRead, AsyncWrite, AsyncReadExt, AsyncWriteExt}, time::sleep};
    ...
    async move {
        ...
        loop {
            ...
            match value {
                ...
                b'?' => drop(output.write_all(b"<Run|MPos:0.00,1.00,3.00|Pn:XY|WCO:5.00,-5.25,17|FS:100,500|Bf:15,128|Ov:25,50,200|A:SM>\n").await),
